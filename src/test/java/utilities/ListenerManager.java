...
public class ListenerManager extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult tr) {
        ...
        TakesScreenshot ts;
        if(testClassSelect.equalsIgnoreCase("[TestClass name=class tests.TestKariera]"))
        {
            ts = (TakesScreenshot) TestKariera.driver;
        }
//        else if (testClassSelect.equalsIgnoreCase("[TestClass name=class tests.TestKariera]"))
//        {
//            ts = (TakesScreenshot) TestKariera.driver;
//        }
